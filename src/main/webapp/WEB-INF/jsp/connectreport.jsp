...
<body>
	...
	<form method="post" name="gettimeentry"
		action="getselectedreportentrytxls.html"
		onsubmit="return validateForm()">


		<table>
			<tr>
				<td><label path="subDomainName"><spring:message
							code="label.subdomain" /></label></td>
				<td><input name="subDomainName" path="subDomainName" /></td>
			</tr>
			<tr>
				<td><label path="miteApiKey"><spring:message
							code="label.miteapikey" /></label></td>
		...
		<div>
			<br> <br> <br> <input type="submit"
				value="<spring:message code="label.connectreoport"/>" />
		</div>
